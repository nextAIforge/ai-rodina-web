            ...
            {tabs.map((tab, index) => (
              tab.link ? (
                <Link
                  key={tab.id}
                  to={tab.link}
                  className="flex items-center gap-1.5 md:gap-2.5 px-3 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl whitespace-nowrap transition-all duration-300 font-medium text-sm md:text-base tab-inactive"
          ...
          <div className="page-transition">
            <div className="card p-5 md:p-10 mb-6 md:mb-8">
              ...
              <ul className="space-y-2 md:space-y-3 text-[#4A5568] text-sm md:text-lg custom-list mb-4 md:mb-6">
                ...
                <li>Výchovou ve víře přiměřenou věku</li>
...
4. Délka: asi 5 minut čtení`}
      ...
      <footer className="border-t border-[#E8E4DE] bg-white/50">
        <div className="max-w-4xl mx-auto px-4 py-8 md:py-12 text-center">
          ...
          <p className="text-[#7A9B8A] font-medium text-sm md:text-base">2025 • S láskou pro rodiče, kteří chtějí vést své děti moudře ke Kristu</p>
        </div>
      </footer>
    </div>
  );
